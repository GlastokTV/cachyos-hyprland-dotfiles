...
hl.bind(mainMod .. " + CTRL + V", hl.dsp.exec_cmd("code"), { description = "Open VSCode (Open Source)" })
...
hl.bind(mainMod .. " + A",  hl.dsp.focus({ direction = "left" }), { description = "Move focus left" })
hl.bind(mainMod .. " + D", hl.dsp.focus({ direction = "right" }), { description = "Move focus right" })
hl.bind(mainMod .. " + W",    hl.dsp.focus({ direction = "up" }), { description = "Move focus up" })
hl.bind(mainMod .. " + S",  hl.dsp.focus({ direction = "down" }), { description = "Move focus down" })
...
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.window.resize({ x = 100, y = 0, relative = true }), { repeating = true }, { description = "Increase window width with keyboard" })
hl.bind(mainMod .. " + SHIFT + J", hl.dsp.window.resize({ x = -100, y = 0, relative = true }), { repeating = true }, { description = "Reduce window width with keyboard" })
hl.bind(mainMod .. " + SHIFT + K", hl.dsp.window.resize({ x = 0, y = 100, relative = true }), { repeating = true }, { description = "Increase window height with keyboard" })
hl.bind(mainMod .. " + SHIFT + I", hl.dsp.window.resize({ x = 0, y = -100, relative = true }), { repeating = true }, { description = "Reduce window height with keyboard" })
...
hl.bind(mainMod .. " + ALT + J", hl.dsp.window.swap({ direction = "l" }), { description = "Swap tiled window left" })
hl.bind(mainMod .. " + ALT + L", hl.dsp.window.swap({ direction = "r" }), { description = "Swap tiled window right" })
hl.bind(mainMod .. " + ALT + I", hl.dsp.window.swap({ direction = "u" }), { description = "Swap tiled window up" })
hl.bind(mainMod .. " + ALT + K", hl.dsp.window.swap({ direction = "d" }), { description = "Swap tiled window down" })
...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot.sh --immediate"), { description = "Take a screenshot" })
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot.sh --delayed"), { description = "Take delayed screenshot" })
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-power -r"), { description = "Restart machine" })
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-power -p"), { description = "Power off the machine completely" })
...
hl.bind(mainMod .. " + SHIFT + ALT + M", hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-toggle-scratchpad-window"), { description = "Toggle window in/out of special workspace magic" })
